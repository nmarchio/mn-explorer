  ...
  return (
    <main className="px-6">
      <div className="flex flex-col gap-4">
        ...
        <p>Million Neighborhoods Africa Database (2023) is made available under the Open Database License. <a style="font-weight:bold" href="http://opendatacommons.org/licenses/odbl/1.0/">http://opendatacommons.org/licenses/odbl/1.0/</a></p>
        ...
        <p>Bettencourt, Luís M. A.; Marchio, Nicholas. (2023). Million Neighborhoods Africa Database. 
          University of Chicago&#39;s Mansueto Institute for Urban Innovation. URL: <a style="font-weight:bold" href="https://www.millionneighborhoods.africa">https://www.millionneighborhoods.africa</a>.</p>
        <p>A complete data dictionary is available <a style="font-weight:bold" href="https://docs.google.com/spreadsheets/d/1S35EhQcmmHtzuPUkiVllzQOVtpdjkdsHpqvMTJtagi8/edit?usp=sharing">here</a>.</p>
      ...
      <div className="flex flex-col mb-4 md:flex-row">
        <div className="md:w-[50%]">
          <p className="mb-2">
            ...
            <a style="font-weight:bold" href="https://dsbprylw7ncuq.cloudfront.net/AF/africa_geodata.parquet"> a single Parquet file here (~8GB).</a>
          </p>
        </div>
