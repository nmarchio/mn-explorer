      ...
      >
        ...
        <div className="absolute bottom-8 right-0 p-2 w-28 bg-white bg-opacity-90 md:p-4 md:w-auto">
          <div className="relative group">
            <button className="btn btn-sm btn-ghost normal-case px-0">{currSchema.name}</button>
            <div className="opacity-0 bg-white text-sm rounded-lg px-2 py-1 absolute bottom-[100%] right-0 w-[200px] shadow-md transform group-hover:opacity-100 transition-all duration-300" style={{pointerEvents: "none"}}>
